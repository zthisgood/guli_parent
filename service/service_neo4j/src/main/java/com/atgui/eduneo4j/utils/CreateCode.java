...
public class CreateCode {
    public static void main(String[] args){
        ...
        // 生成的代码放哪里
        final String projectPath = System.getProperty("user.dir") + "/service/service_neo4j";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mathgraph?serverTimezone=GMT%2B8");
...
//        pc.setModuleName("");
        // 工程的包名
        pc.setParent("com.atgui.eduneo4j");
